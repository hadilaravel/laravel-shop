                    ...
                    <section class="row mt-4">
                                ...
                                <section class="product-gallery">
                                    ...
                                    <section class="product-gallery-thumbs">
                                        @foreach ($images as $key => $image)
                                            ...
                                            <img class="product-gallery-thumb" src="{{ asset($image) }}" alt="{{ asset($image) . '-' . ($key + 1) }}" data-input="{{ asset($image) }}">
                        ...
                        <section class="col-md-5">
                            ...
                            <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                                ...
                                <form action="{{ route('customer.sales-process.add-to-cart' , $product) }}" id="add_to_cart" method="post" class="product-info">
                                        @csrf
                                    @php
...
{{--                                        compare--}}
                                        @guest
                                            <section class="product-add-to-compare position-relative" style="top: 0">
                                                <button class="btn btn-light btn-sm text-decoration-none" data-url="{{ route('customer.market.add-to-compare', $product) }}" data-bs-toggle="tooltip" data-bs-placement="left" title="اضافه به  مقایسه">
                                        ...
                                        @auth
                                            @if ($product->compares->contains(function ($compare , $key){
                                                ...
                                                <section class="product-add-to-compare position-relative" style="top: 0">
                                                    <button class="btn btn-light btn-sm text-decoration-none" data-url="{{ route('customer.market.add-to-compare', $product) }}" data-bs-toggle="tooltip" data-bs-placement="left" title="حذف از  مقایسه">
                        ...
                        <section class="col-md-3">
                            <form class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                <section class="d-flex justify-content-between align-items-center">
                                ...
                                <section class="">
                                    @if($product->marketable_number > 0)
                                        <button id="next-level" onclick="document.getElementById('add_to_cart').submit();" class=" w-100 btn btn-danger d-block">افزودن به سبد خرید</button>
                                    @else
                                            ...
                                            <section class="product">
                                                ...
                                                @guest
                                                    <section class="product-add-to-favorite">
                                                        <button type="button" data-url="{{ route('customer.market.add-to-favorite' , $relatedProduct) }}" class=" btn btn-light btn-sm text-decoration-none"  data-bs-toggle="tooltip" data-bs-placement="left" title="افزودن به علاقه مندی">
                                                            <i class="fa fa-heart "></i>
                                                        </button>
                                                    </section>
                                                @endguest
                                                ...
                                                @auth
                                                    @if($relatedProduct->user->contains(auth()->user()->id))
                                                        <section class="product-add-to-favorite">
                                                            <button type="button" data-url="{{ route('customer.market.add-to-favorite' , $relatedProduct) }}" class=" btn btn-light btn-sm text-decoration-none"  data-bs-toggle="tooltip" data-bs-placement="left" title="حذف از علاقه مندی">
                                                                <i class="fa fa-heart text-danger"></i>
                                                            </button>
                                                        </section>
                                                    @else
                                ...
                                <!-- start rating -->
                                    ...
                                    <section class="product-rating mb-4">
                                        ...
                                        <div class="container">
                                            ...
                                            <form class="starrating risingstar d-flex justify-content-end flex-row-reverse align-items-center"
