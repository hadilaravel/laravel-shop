                            ...
                            <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                                ...
                                <section class="address-select">
                                    ...
                                    @foreach (auth()->user()->addresses as $address)
                                        <input type="radio" name="address_id"  form="myForm" value="{{ $address->id }}" id="a-{{ $address->id }}" />
                                        <!--checked="checked"-->
                                            <label for="a-{{ $address->id }}" class="address-wrapper mb-2 p-2">
                                                ...
                                                <a class=""  type="button" data-bs-toggle="modal"
                                                    ...
                                                    <section class="modal-body">
                                                        <form class="row" method="post" action="{{ route('customer.sales-process.update-address' , $address->id) }}">
                                                            ...
                                                            <section class="col-6 mb-2">
                                                                ...
                                                                <select name="province_id"
                                                                    ...
                                                                    @foreach ($provinces as $province)
                                                                        <option {{ $address->province_id == $province->id ? 'selected' : '' }} value="{{ $province->id }}" @if(old('province_id') == $province) selected @endif data-url="{{ route('customer.sales-process.get-cities', $province->id) }}">
                                                                            {{ $province->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <section class="col-12 mb-2">
                                                                ...
                                                                <textarea name="address" class="form-control form-control-sm" id="address" placeholder="نشانی">{{ old('address' , $address->address) }}</textarea>
                                                            </section>
                                                            ...
                                                            <section class="col-6 mb-2">
                                                                ...
                                                                <input type="text" name="postal_code"
                                                                       ...
                                                                       placeholder="کد پستی" value="{{ old('postal_code' , $address->postal_code) }}">
                                                            </section>

                                                            <section class="col-3 mb-2">
                                                                <label for="no" class="form-label mb-1">پلاک</label>
                                                                <input type="text" name="no" value="{{ old('no' , $address->no) }}"
                                                            ...
                                                            <section class="col-3 mb-2">
                                                                ...
                                                                <input type="text" name="unit"  value="{{ old('unit' , $address->unit) }}"
                                                            ...
                                                            <section class="col-6 mb-2">
                                                                <label for="first_name" class="form-label mb-1">نام
                                                                    گیرنده</label>
                                                                <input type="text" name="recipient_first_name" value="{{ $address->recipient_first_name ?? $address->recipient_first_name  }}"
                                                            ...
                                                            <section class="col-6 mb-2">
                                                                ...
                                                                <input type="text" name="recipient_last_name" value="{{ $address->recipient_last_name ?? $address->recipient_last_name  }}"
                                                            ...
                                                            <section class="col-6 mb-2">
                                                                <label for="mobile" class="form-label mb-1">شماره
                                                                    موبایل</label>
                                                                <input type="text" name="mobile" value="{{ $address->mobile ?? $address->mobile  }}"
                                                        ...
                                                        <form class="row" method="post" action="{{ route('customer.sales-process.add-address') }}">
                                                            ...
                                                            <section class="col-6 mb-2">
                                                                ...
                                                                <select name="province_id"
                                                                    ...
                                                                    @foreach ($provinces as $province)
                                                                        <option value="{{ $province->id }}" @if(old('province_id') == $province) selected @endif data-url="{{ route('customer.sales-process.get-cities', $province->id) }}">
                                                                            {{ $province->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
