...
class PageController extends Controller
{
    ...
    public function store(PageRequest $request)
    {
        ...
        $slug = persianSlug($page->title) . '-' . $page->id;
        $page->update(['slug' => $slug]);
        return redirect()->route('admin.content.page.index')->with('swal-success' , 'صفحه  با موفقیت ثبت شد');
    }
    ...
    {
        $page->delete();
        return redirect()->route('admin.content.page.index')->with('swal-success' , 'صفحه با موفقیت پاک شد');
    }
