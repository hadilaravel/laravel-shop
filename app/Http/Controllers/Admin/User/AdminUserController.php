...
class AdminUserController extends Controller
{
    ...
    public function update(AdminUserRequest $request, User $admin , ImageService $imageService)
    {
        ...
        $admin->update($inputs);
        return redirect()->route('admin.user.admin-user.index')->with('swal-success', '  ادمین سایت شما موفقیت ویرایش شد');
    ...
    public function rolesStore(Request $request , User $admin)
    {
        ...
        return redirect()->route('admin.user.admin-user.index')->with('swal-success' , 'نفش با موفقیت ویرایش شد');
    }
