...
use App\Http\Controllers\Customer\Profile\AddressesController as ProfileAddressController;
...
use App\Http\Controllers\Customer\SalesProcess\PaymentController as PaymentPortController;
...
Route::prefix('admin')->middleware([ 'auth' ,'role:admin'])->namespace('Admin')->group(function () {
    ...
    Route::prefix('market')->middleware('role:SalesAdmin')->namespace('Market')->group(function () {
    ...
    Route::prefix('content')->middleware('role:ContentAdmin')->namespace('Content')->group(function () {
        ...
        //category
//        Route::prefix('category')->middleware('role:editor')->group(function () {
...
//        });
    ...
    Route::prefix('user')->middleware('role:GeneralAdmin')->namespace('User')->group(function () {
    ...
    Route::prefix('notify')->middleware('role:GeneralAdmin')->namespace('Notify')->group(function () {
    ...
    Route::prefix('ticket')->middleware('role:GeneralAdmin')->namespace('Ticket')->group(function () {
    ...
    Route::prefix('setting')->middleware('role:GeneralAdmin')->namespace('Setting')->group(function () {
    ...
    Route::middleware('role:GeneralAdmin')->post('notification/read-all' , [\App\Http\Controllers\Admin\NotificationController::class , 'readAll'])->name('admin.notification.readAll');
});
...
Route::namespace('Market')->group(function(){
    ...
    Route::post('add-rate/product/{product}' , [MarketProductController::class , 'addRate'] )->name('customer.market.add-rate');
});
...
//        payment
        Route::get('payment' , [PaymentPortController::class , 'payment'])->name('customer.sales-process.payment');
        Route::post('copan-discount' , [PaymentPortController::class , 'copanDiscount'])->name('customer.sales-process.copan-discount');
        Route::post('payment-submit' , [PaymentPortController::class , 'paymentSubmit'])->name('customer.sales-process.payment-submit');
        Route::any('payment-callback/{order}/{onlinePayment}' , [PaymentPortController::class , 'paymentCallback'])->name('customer.sales-process.payment-call-back');
    });
...
Route::namespace('Profile')->middleware('auth')->group(function() {
    ...
    Route::get('my-tickets/download/{ticketFile}' , [ProfileTicketController::class , 'downloadFile'])->name('customer.profile.my-tickets.download-file');
});
