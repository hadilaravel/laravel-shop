...
class CategoryController extends Controller
{
    ...
    public function store(ProductCategoryRequest $request , ImageService $imageService)
    {
        ...
        $slug = persianSlug($productCategory->original_name) . '-' . $productCategory->id;
        $productCategory->update(['slug' => $slug]);
    ...
    public function destroy(ProductCategory $productCategory)
    {
        ...
        return redirect()->route('admin.market.category.index')->with('swal-success' , 'دسته یندی شما با موفقیت حذف شد');
    }
}
