                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('title' , $post->title) }}" class="form-control form-control-sm" name="title" >
                            </div>
                            @error('title')
...
{{--                                <img src="{{ asset($post->image['indexArray'][$post->image['currentImage']] ) }}" class="mt-3" alt="" width="100" height="50">--}}
                            </div>
                            @error('image')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="commentable	">امکان درح کامنت</label>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="published_at"  name="published_at" class="d-none form-control form-control-sm" name="">
                                <input type="text" id="published_at_view"  class="form-control form-control-sm" name="">
                            </div>
                            @error('published_at')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
