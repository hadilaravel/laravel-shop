                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ old('name' , $attribute->name) }}" class="form-control form-control-sm">
                            </div>
                            @error('name')
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="unit" value="{{ old('unit' , $attribute->unit) }}" class="form-control form-control-sm">
                            </div>
                            @error('unit')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
