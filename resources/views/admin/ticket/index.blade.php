                ...
                <table class="table table-striped table-hover">
                    ...
                    @foreach($tickets as $key => $ticket)
                        <tr>
                            ...
                            <td> {{ $ticket->admin == null ? 'نامشخص'  : $ticket->admin->user->fullName }}	</td>
                            ...
                            <td class="width-16-rem text-left">
                                ...
                                <a href="{{ route('admin.ticket.change' , $ticket->id) }}" class="btn btn-{{ $ticket->status == 1 ? 'success ' : 'danger' }} btn-sm"><i class="fa fa-{{ $ticket->status == 1 ? 'check ' : 'times' }}"></i>
