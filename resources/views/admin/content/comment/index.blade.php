                    ...
                    @foreach($comments as $key => $comment)
                        <tr>
                            ...
                            @if($comment->approved == 1)
                                <a class="btn btn-warning btn-sm"  href="{{ route('admin.content.comment.approved' , $comment->id) }}" type="submit"><i class="fa fa-clock"></i> عدم تایید</a>
                                @else
                                <a class="btn btn-success btn-sm text-white" href="{{ route('admin.content.comment.approved' , $comment->id) }}" type="submit"><i class="fa fa-check"></i> تایید</a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
