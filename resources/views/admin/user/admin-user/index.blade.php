                        ...
                        @foreach ($admins as $key => $admin)
                            ...
                            <tr>
                                ...
                                <td class="width-22-rem text-left">
                                    <a href="{{ route('admin.user.admin-user.roles' , $admin->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-user-check"></i> نقش</a>
                                    <a href="{{ route('admin.user.admin-user.permissions' , $admin->id) }}" class="btn btn-info btn-sm"><i class="fa fa-user-shield"></i> سطوح دسترسی</a>
