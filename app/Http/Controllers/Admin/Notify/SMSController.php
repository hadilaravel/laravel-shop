...
class SMSController extends Controller
{
    ...
    public function store(SMSRequest $request)
    {
        ...
        return redirect()->route('admin.notify.sms.index')->with('swal-success' , 'پیامک شما با موفقیت ثیت شد');
    }
...
//        dd($inputs['published_at']);
    ...
    {
        $sms->delete();
        return redirect()->route('admin.notify.sms.index')->with('swal-success' , 'پیامک با موفقیت پاک شد');
    }
