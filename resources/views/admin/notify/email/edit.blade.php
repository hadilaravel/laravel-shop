                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="published_at" id="published_at"
                                           class="form-control form-control-sm d-none" value="{{  jalaliDate($email->published_at ) }}">
                                    <input type="text" id="published_at_view" class="form-control form-control-sm" value="{{ jalaliDate($email->published_at ) }}">
                                </div>
                                @error('published_at')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                    <strong>
