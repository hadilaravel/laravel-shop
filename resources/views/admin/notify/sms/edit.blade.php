                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{ old('title' , $sms->title) }}" class="form-control form-control-sm">
                            </div>
                            @error('title')
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="published_at" value="{{ jalaliDate($sms->published_at) }}"  name="published_at" class="d-none form-control form-control-sm" name="">
                                <input type="text" id="published_at_view" value="{{ jalaliDate($sms->published_at)}}" class="form-control form-control-sm" name="">
                            </div>
                            @error('published_at')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
