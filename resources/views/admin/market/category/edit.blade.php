...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item font-size-12 active" aria-current="page"> ویرایش ایجاد دسته بندی</li>
    </ol>
  </nav>
  ...
  <section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form action="{{ route('admin.market.category.update' , $productCategory->id) }}" method="post" id="form" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('put') }}
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <select name="show_in_menu" id="show_in_menu" class="form-control form-control-sm" id="show_in_menu">
